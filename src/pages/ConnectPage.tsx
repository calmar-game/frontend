...
export function ConnectPage() {
  ...
  const { isConnected, isLoading, userProfile } = useWallet();
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-black grid-pattern">
      <div className="max-w-md w-full mx-auto text-center px-6">
        ...
        <h1 className="text-xl md:text-2xl neon-text mb-4 tracking-wider">CryptoRunner</h1>
        ...
        <div className="glass-effect pixel-corners p-4 mb-8">
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-gray-300">Connect your Solana wallet to start playing and track your progress</p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 flex-shrink-0 rounded-full bg-[#00ff00]/10 flex items-center justify-center">
                <span className="text-[#00ff00] text-sm">2</span>
              </div>
              <p className="text-sm text-gray-300">Your $PYTHIA balance determines your energy capacity</p>
            </div>
          </div>
        </div>
        ...
        <WalletMultiButton className="w-full bg-black/50 text-[#00ff00] p-4 glass-effect pixel-corners
